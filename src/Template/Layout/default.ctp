<?php
$cakeDescription = 'Thema Bootstrap';
?>
<!DOCTYPE html>
<!--
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><?= $this->Html->link(__('Listado'), ['controller'=> 'Proyectos', 'action' => 'index']) ?></li>
            <li><?= $this->Html->link(__('Nuevo'), ['controller' => 'Proyectos', 'action' => 'add']) ?></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#"><i class="fa fa-link"></i> <span>Alumnos</span> <i class="fa fa-angle-left pull-right"></i></a>
          <ul class="treeview-menu">
            <li class="active"><?= $this->Html->link(__('Listado'), ['controller'=> 'Alumnos', 'action' => 'index']) ?></li>
