...
class AlumnosController extends AppController
{
    ...
    {
        //Opciones que vamos a aplicar a la paginacion
		$this->paginate = [
			'limit' => 2, //cuando registros queres ver por pagina
			
			'order' => [ //ordenamiento de los datos inicial
				'Alumnos.nombre' => 'asc'
			]
		];
    ...
    public function add()
    {
        ...
        $proyectos = $this->Alumnos->Proyectos->find('list', ['limit' => 200]);
        $this->set(compact('alumno', 'proyectos'));
        $this->set('_serialize', ['alumno']);
    }
